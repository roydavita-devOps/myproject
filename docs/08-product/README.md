...
This folder contains future-facing commercial SaaS product planning. It must not contain implementation reports.

Core documents:

- [TEMPLATE_MARKETPLACE.md](./TEMPLATE_MARKETPLACE.md)
